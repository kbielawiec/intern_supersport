...
=====================
Introduction to katietheme
=====================

katietheme boasts a clean HTML5 structure with extensible CSS classes and IDs for
...
katietheme's goal is to provide themers the building blocks needed to get their
designs up and running quickly and simply.

katietheme is perfect if you want a simple, smart, and flexible theme starter.
...
katietheme utilizes SASS for adaptive grids and layouts and general structure of the
...
katietheme is meant to be YOUR theme. Follow one of the two methods below and you can
rename 'katietheme' to another name like 'mytheme'. You're also welcome to keep
'katietheme'.

1. DRUSH: The provided drush install script will duplicate the katietheme theme
   folder and rename all appropriate files and content to the new theme name you
   provide.

  - Download and enable the katietheme theme: $ drush en katietheme
  - Set the theme as default $ drush config-set system.theme default katietheme
    or copy the includes/katietheme.drush.inc into your .drush folder.
  - Run the provided drush install script: $ drush katietheme-install
  ...
  - At this time, you can uninstall katietheme: $drush pmu katietheme
...
2. MANUAL: To manually change the name of the theme follow these steps BEFORE
  ...
  - Rename katietheme.info.yml to mytheme.info.yml
  - edit katietheme.info.yml and change the name, description, project (can be
    deleted), and change all other instances of 'katietheme' to 'mytheme'
  - Rename katietheme.libraries.yml to mytheme.libraries.yml
  - Rename katietheme.theme to mytheme.theme
  - in katietheme.theme, change each instance of 'katietheme' to 'mytheme'
  - Rename config/schema/katietheme.schema.yml to mytheme.schema.yml
  - Rename each file in config/install from block.block.katietheme_tools.yml (for
    example) to block.block.mytheme_tools.yml
  - Every file in config/install, change each instance of 'katietheme' to
    'mytheme'
  - In js/source/scripts.js, change each instance of 'katietheme' to 'mytheme'
  - In theme-settings.php, change each instance of 'katietheme' to 'mytheme'
  - In templates/html.html.twig, change each instance of 'katietheme' to 'mytheme'
  - In templates/menu-local-tasks.html.twig, change each instance of 'katietheme' to
    'mytheme'
  - In templates/status-messages.html.twig, change each instance of 'katietheme' to
    'mytheme'

  When renaming, remember the following:
  - Do not simply replace every instance of 'katietheme' in every file in the theme.
    Most of katietheme's dependencies use the word 'katietheme' somewhere and renaming
    these instances will cause katietheme to break in unpredictable ways.
  ...
  - If you don't bother renaming katietheme in the above locations, be advised that
    you will run into conflicts with other versions of katietheme on your site. If
    your site uses more than one theme based on katietheme, make sure at least one of
    the themes has been renamed properly!


============================
How to compile SASS in katietheme
============================

To use SASS and automatically compile it within your theme, please refer to "How
to Use Grunt with katietheme" in the documentation below.
...
- build/scripts.js & source/scripts.js
  ...
  folder. See comments in katietheme.libraries.yml file to enable the starter
  scripts.js file.
...
The layout used in katietheme is fairly similar to the Holy Grail method. It has been
...
This is how the page template is buit in katietheme, and it works in fluid and fixed
layout. Refer to the notes in layout.sass to see how to modify the layout.


===========================
How to Use Grunt with katietheme
===========================
...
Once Node.JS is installed, go to the root folder of katietheme and install your Grunt
packages:
...
Once installed, cd to the root folder of katietheme and run Grunt via the command
line:
...
Once you start using katietheme, you will massively change it until you reach the
point where it has nothing to do with katietheme anymore. Unlike Zen, katietheme is not
...
version of katietheme comes out. Always see katietheme as a STARTER, and as soon as you
start using it, it is not katietheme anymore, but your own theme.

If you didn't rename your theme, but you don't want to be notified when katietheme
has a new version by the update module, simply delete "project = "katietheme" in
katietheme.info.yml.
...
Thanks for using katietheme, and remember to use the issue queue in drupal.org for
any questions or bug reports:

http://drupal.org/project/issues/katietheme
